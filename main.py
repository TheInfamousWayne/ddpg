...
def train(num_episodes, agent, env, output, evaluate=None, validate_steps=None, max_episode_length=None, debug=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='gym_finger:Finger-v0', type=str, help='open-ai gym environment')
    parser.add_argument('--hidden1', default=32, type=int, help='hidden num of first fully connect layer')
    parser.add_argument('--hidden2', default=16, type=int, help='hidden num of second fully connect layer')
...
#    agent = DDPG(nb_states, nb_actions, args)
    ...
    train(args.max_episodes, agent, env, args.output, evaluate, args.validate_steps,
